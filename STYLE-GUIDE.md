...
[[2]], so I would like to thank the author Tim Pope.
...
to a bug reported to us by a specific distribution of Linux or a \*BSD.
Also, `[Distro]` should be replaced with the name of the distribution,
e.g. `X-Gentoo-Bug`.
